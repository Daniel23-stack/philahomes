...
<template>
  <div class="lte-wrapper client-portal admin-shell">
    <ClientSidebar v-model:open="sidebarOpen" />
    ...
    <div class="lte-content-wrapper">
      <nav class="lte-navbar">
        <ul class="lte-navbar__left">
          ...
          <li class="lte-navbar__item d-none-sm">
            <Link href="/" class="lte-navbar__link">Back to website</Link>
          </li>
        </ul>
      ...
      <footer class="lte-footer">
        <strong>Okuhle Homes</strong> Client portal &copy; {{ new Date().getFullYear() }}
      </footer>
    </div>
